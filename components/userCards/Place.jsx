...
const Place = ({ id }) => {
	...
	return (
		<div className="mantine-carousel relative bg-white shadow-md h-[390px]  w-[280px] rounded-2xl  overflow-y-scroll">
			<Carousel
				maw={280}
				mx="auto"
				withIndicators
			...
			<div className="mt-4 mx-4 flex justify-between">
				<h1 className="text-dark text-lg font-semibold text-center truncate overflow-ellipsis  max-w-[240px] ">
					{modalData.title}
				</h1>
				<div className="text-orange flex gap-1 ml-2">
					<AiFillStar size={26} />
					<h3 className="text-lg font-bold">{modalData.rating}</h3>
				</div>
			</div>
			<div className="flex ml-5 mt-1 items-center gap-1">
				<GoLocation size={24} className="text-orange" />
				<h3 className="text-dark text-sm">{modalData.wilaya}</h3>
			</div>
			<div
