...
const Events = ({ events, status }) => {
	...
	return (
		<section className="h-screen bg-white pl-44 pt-11">
			<h1 className="font-bold text-4xl text-dark">Evenements</h1>
			...
			<div>
				<div className="mt-10 mr-[400px] overflow-x-auto">
					<div className="flex gap-5">
						...
						<h2 className="w-[300px] text-center text-gray-500 ml-7">
							Titre
						</h2>
						...
						{data.map((item) => (
							...
							>
								...
								<div className="w-[300px] ml-7 ">
									<p className=" text-dark font-semibold truncate hover:underline cursor-pointer ">
										{item.title}
									</p>
								</div>
